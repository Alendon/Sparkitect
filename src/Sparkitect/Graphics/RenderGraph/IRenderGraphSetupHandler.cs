...
public interface IRenderGraphSetupHandler
{
    ...
    /// <paramref name="window"/>, resolving passes and facts against the per-graph
    /// <paramref name="graphContainer"/>. Throws <see cref="InvalidOperationException"/> if any required
