...
/// Each registration call forwards the id into <see cref="IPassTypesRegistryFacade"/>
/// for tracking.
/// </summary>
[Registry(Identifier = "render_pass")]
[PublicAPI]
public partial class RenderPassRegistry(IPassTypesRegistryFacade passTypes) : IRegistry
{
    [RegistryMethod]
