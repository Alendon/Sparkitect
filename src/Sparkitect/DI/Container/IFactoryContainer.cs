...
[PublicAPI]
public interface IFactoryContainer<TKey, TBase> : IDisposable
    where TBase : class
    where TKey : notnull
{
    /// <summary>
    ...
    IReadOnlyDictionary<TKey, TBase> ResolveAll();
    ...
    bool TryResolve(TKey key, [NotNullWhen(true)] out TBase? instance);
}
