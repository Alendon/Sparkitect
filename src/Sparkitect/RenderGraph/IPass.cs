...
/// </para>
/// <para>
/// The render-graph foundation is Vulkan-agnostic. Vulkan concerns, resource
/// concerns, descriptor concerns, and synchronization concerns are all
/// handled by emergent layers (Phases 48-68).
/// </para>
/// </remarks>
