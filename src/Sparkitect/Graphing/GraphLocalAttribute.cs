...
/// <summary>
/// Marks a class as a graph-local service for a graphing category. The class is collected into a
/// per-graph core container discriminated by <typeparamref name="TGraphBaseType"/> and registered as
