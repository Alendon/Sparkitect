...
/// <summary>Link-stage structural diagnostics, each carrying its provenance. The compile outcome is a <c>Result&lt;CompiledPlan, CompileError&gt;</c>.</summary>
[DiscriminatedUnion]
[PublicAPI]
public abstract partial record CompileError
{
    /// <summary>Two increments declared from the same source epoch; concurrent writers are structurally inexpressible.</summary>
