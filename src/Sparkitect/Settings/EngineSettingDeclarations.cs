...
public static class EngineSettingDeclarations
{
    ...
    public static SettingDefinition<bool> VulkanValidation => new(true, CliOption: "vkvalidation");
    ...
    public static SettingDefinition<uint> FpsCap => new(0u, CliOption: "fpsCap");

    /// <summary>Default window width. Not fed by the engine-config source (D-20).</summary>
    ...
    /// <summary>Default window height. Not fed by the engine-config source (D-20).</summary>
    ...
    public static SettingDefinition<LogEventLevel> LogLevel => new(LogEventLevel.Debug, CliOption: "logLevel");
    ...
    public static SettingDefinition<string> LogDirectory => new("logs", CliOption: "logDir");
}
