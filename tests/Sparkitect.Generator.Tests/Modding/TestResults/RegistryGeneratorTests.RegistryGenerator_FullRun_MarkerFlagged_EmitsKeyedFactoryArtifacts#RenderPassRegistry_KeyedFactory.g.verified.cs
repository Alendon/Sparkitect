//HintName: RenderPassRegistry_KeyedFactory.g.cs
...
internal class RenderPassRegistry_KeyedFactory : global::Sparkitect.DI.IKeyedFactory<Sparkitect.Modding.IRegistryBase>
{
    // Cached dependencies
    
    

    public Type ImplementationType => typeof(RenderPassRegistry);
    ...
    public Sparkitect.Modding.IRegistryBase CreateInstance()
    {
        ...
        static extern RenderPassRegistry Constructor(
