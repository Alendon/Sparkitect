...
public class PropertyCircularService1Factory : IServiceFactory
{
    ...
    public object CreateInstance(IResolutionScope scope) => new PropertyCircularService1();
...
public class PropertyCircularService2Factory : IServiceFactory
{
    ...
    public object CreateInstance(IResolutionScope scope) => new PropertyCircularService2();
