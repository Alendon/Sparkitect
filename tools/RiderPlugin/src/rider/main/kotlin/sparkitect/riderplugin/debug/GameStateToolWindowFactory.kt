...
/**
 * The "Sparkitect Game State" tool window: always available, registered in plugin.xml with no
 ...
 * backend is the sole game-channel client, so everything the window renders arrives over the
